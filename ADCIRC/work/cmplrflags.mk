...
LIBSS   :=  -lnetcdff  -lnetcdf -lhdf5 -lhdf5_fortran 
FLIBS   := $(LIBDIRS)  $(LIBSS)
...
#  PFC           :=  mpiifort
#  PFC           :=  mpif90
  FFLAGS1       :=  $(INCDIRS) -g -traceback -check all -debug all -w -O0 -FI -assume byterecl -132 -i-dynamic -assume buffered_io
  FFLAGS2       :=  $(FFLAGS1)
  FFLAGS3       :=  $(FFLAGS1)
  DA            :=  -DREAL8 -DLINUX -DCSCA
  DP            :=  -DREAL8 -DLINUX -DCSCA -DCMPI
