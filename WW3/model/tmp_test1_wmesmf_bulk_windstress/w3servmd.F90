...
!/
      ...
      IF ( RUN ) THEN
        ...
        ELSE ! error state
          WRITE(*,*) 'w3servmd MPI_ABORT, IEXIT=', IEXIT
          IF (PRESENT(UNIT)) THEN
            WRITE(*,*) 'w3servmd UNIT=', UNIT
          ELSE
            WRITE(*,*) 'w3servmd UNIT missing'
          END IF
          IF (PRESENT(MSG)) THEN
            WRITE(*,*) 'w3servmd MSG=', MSG
          ELSE
            WRITE(*,*) 'w3servmd MSG missing'
          END IF
          IF (PRESENT(FILE)) THEN
            WRITE(*,*) 'w3servmd FILE=', FILE
          ELSE
            WRITE(*,*) 'w3servmd FILE missing'
          END IF
          IF (PRESENT(LINE)) THEN
            WRITE(*,*) 'w3servmd LINE=', LINE
          ELSE
            WRITE(*,*) 'w3servmd LINE missing'
          END IF
          IF (PRESENT(COMM)) THEN
            WRITE(*,*) 'w3servmd COMM=', COMM
          ELSE
            WRITE(*,*) 'w3servmd COMM missing'
          END IF
