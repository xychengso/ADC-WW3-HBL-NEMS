...
! XYC note: TUS[X,Y] may not have shallow water effect included.
...
! XYC note:
!          TUSX(JSEA) = TUSX(JSEA) + ABX(JSEA)*FACTOR               &
!                     *GRAV*WN(IK,ISEA)/SIG(IK)/tanh(2*WN(IK,ISEA)*DW(ISEA))
!          TUSY(JSEA)  = TUSY(JSEA) + ABY(JSEA)*FACTOR               &
!                     *GRAV*WN(IK,ISEA)/SIG(IK)/tanh(2*WN(IK,ISEA)*DW(ISEA))
! XYC added
...
!                                                      SIN(USTDIR(ISEA))
                          AUX1(ISEA) = USTFLD(ISEA) * ASF(ISEA) *        &
                                                     COS(USTDIRFLD(ISEA))
                          AUX2(ISEA) = USTFLD(ISEA) * ASF(ISEA) *        &
                                                      SIN(USTDIRFLD(ISEA))
                        ELSE
                          AUX1(ISEA) = UNDEF
                          AUX2(ISEA) = UNDEF
