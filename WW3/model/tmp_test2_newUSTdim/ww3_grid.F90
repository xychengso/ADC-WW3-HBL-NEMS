...
!
      ...
      INTEGER                 :: TAILTYPE
      REAL                    :: TAILLEV, TAILT1, TAILT2, WINDFAC
!
...
!
      NAMELIST /FLD1/ TAILTYPE, TAILLEV, TAILT1, TAILT2, WINDFAC
...
!
      ...
      SSDSC(11)   = SDSSTRAIN2 ! enhanced straining constant ...
      SSDSBR   = SDSBR
      SSDSBRF1 = SDSBRF1
      SSDSBRFDF= SDSBRFDF
      SSDSBM(0)   = SDSBM0
...
!
 ...
 2924 FORMAT ( '  &SDS4 SDSC1 =',E12.4,', SDSC2 =',E12.4,        &
               ...
               ', SDSSTRAIN =',F4.1,', SDSSTRAINA =',F4.1,       &
               ', SDSSTRAIN2 =',F5.1,', '/                       &
