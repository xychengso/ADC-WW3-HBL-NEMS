...
!
      INTEGER, ALLOCATABLE    :: IPBPI(:,:), IPBPO(:,:), NCID(:),      &
                                 DIMID(:,:), DIMLN(:,:)
!
      REAL                    :: FR1I, TH1I, FACTOR, OFFSET, DMIN,     &
...
!
 1005 FORMAT (/' *** WAVEWATCH III ERROR IN W3BOUNC: '/               &
               ...
               '     ILLEGAL NKI =',I3,' DIFFERS FROM NK1 =',I3/      &
               '     ILLEGAL NTHI =',I3,' DIFFERS FROM NTH1 =',I3/)
!
...
!
 1007 FORMAT (/' *** WAVEWATCH III ERROR IN W3BOUNC: '/               &
               '     ILLEGAL XFR CALCULATED FROM FREQ(2)/FREQ(1)'/    &
               '     XFR DEFINED FROM MOD_DEF.WW3 =',F12.6/)
!
